...
```shell
sh -c "$(curl -fsSL https://raw.githubusercontent.com/d4rker/oh-my-zsh/master/oh-my-zsh.sh)"
```

#### via wget

```shell
sh -c "$(wget https://raw.githubusercontent.com/d4rker/oh-my-zsh/master/oh-my-zsh.sh -O -)"
```
